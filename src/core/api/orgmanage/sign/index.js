...
// 审核
export const auditUserApi = (id, type, auditReason) => request({
  method: 'put',
  url: `${BASE_PATH}/audit/${id}/${type}`,
  data: {
    auditReason
  }
})
...
// 去认证
export const toAuditUserApi = (data) => request({
  url: `${BASE_PATH}/toAudit`,
  data
})
...
// 导出用户列表
export const exportUserApi = (data) => request({
...
// 我的积分
export const mineScoreApi = (id, data, del = 0) => request({
...
// 用户统计
export const userCountApi = (depId) => request({
  method: 'get',
  url: `${BASE_PATH}/account/${depId}`
})
// 签到统计
