        ...
        <div class="publicOrgBox">
            <div class="publicOrgTitle">
                <el-form :inline="true" class="demo-form-inline">
                  <el-form-item label="新闻类型:">
                    <my-select field="subType" :options="articleType.info || {}" :change="changeType"/>
                  </el-form-item>
            ...
            <el-table :data="tableData" border style="width: 100%" v-loading="loading">
              ...
              <el-table-column prop="files" :show-overflow-tooltip="true"
                 :formatter="({subType})=>typeFilter(articleType.info,subType)"
                 label="新闻类型" align="center">
              </el-table-column>
              ...
              <el-table-column fixed="right" label="操作" align="center" width="200px">
                  <template slot-scope="scope">
                      <el-button type="text" size="small" @click="goUrl(['newsdetail',{id:scope.row.id}])">查看/编辑</el-button>
...
export default {
  ...
  methods: {
    ...
    loadData () {
      this.loading = true
      this.findArticleApi([5, 0]).then((data) => {
