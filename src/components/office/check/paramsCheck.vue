<template lang="pug">
  #paramsCheck.wrapper-content
    c-header.wrapper-paramsCheck-header(:menuNames="menuNames")
    .wrapper-paramsCheck-content
      .wrapper-paramsCheck-middle
        .left
          .wrapper-row
            .row
              header
